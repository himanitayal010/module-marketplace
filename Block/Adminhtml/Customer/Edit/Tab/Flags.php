...
class Flags extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Hts\Marketplace\Model\ResourceModel\SellerFlags\CollectionFactory $flagsFactory,
        array $data = []
    ) {
    ...
    {
        /** @var $collection \Hts\Marketplace\Model\ResourceModel\SellerFlags\Collection */
