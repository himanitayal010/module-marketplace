...
class Tabs extends Generic implements TabInterface
{
    ...
    public function initForm()
    {
        ...
        $data = '<input type="hidden" id="ht_mp_store0" value="'.$storeUrl.'">';
        foreach ($allStores as $store) {
            $storeUrl = $currentUrlBase."store/".$store->getId()."/";
            $data = $data.'<input type="hidden" id="ht_mp_store'.$store->getId().'" value="'.$storeUrl.'">';
        }
            ...
            [
                ...
                require([
                    ...
                    $("#marketplace_store_id").on("change", function() {
                        ...
                        window.location.href = $("#ht_mp_store"+storeId).val();
                    });
                });
                </script>'
            ]
    ...
    public function getFormHtml()
    {
        ...
        $html .= $this->getLayout()->createBlock(
            \Hts\Marketplace\Block\Adminhtml\Customer\Edit\Js::class
        )->toHtml();
