...
namespace Hts\Marketplace\Block\Order;

/*
 * Hts Marketplace Order History Block
 */
...
class History extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Hts\Marketplace\Helper\Orders                $ordersHelper
    ...
    public function __construct(
        ...
        \Hts\Marketplace\Helper\Orders $ordersHelper,
        MpHelper $mpHelper,
        array $data = []
    ) {
    ...
    /**
     * @return bool|\Hts\Marketplace\Model\ResourceModel\Saleslist\Collection
     */
    ...
    public function getpronamebyorder($orderId, $wrap = false)
    {
        ...
        foreach ($collection as $res) {
            ...
            if ($wrap) {
                $result .= "<div class='ht-order-item-block'>".$productName."</div>";
            } else {
                $result .= $productName;
            }
        }
