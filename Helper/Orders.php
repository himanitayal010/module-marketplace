...
use Hts\Marketplace\Model\OrdersFactory as MpOrdersFactory;
...
class Orders extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     *
     * @param \Hts\Marketplace\Model\Saleslist $res
     *
     * @return array
     */
    ...
    public function getWrappedHtml($html, $wrap = false, $class = 'ht-order-item-row')
    {
        if ($wrap) {
