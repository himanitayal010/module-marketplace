...
use Hts\Marketplace\Model\ResourceModel\Saleperpartner\CollectionFactory as SalePerPartnerCollection;
use Hts\Marketplace\Model\ResourceModel\Saleslist\CollectionFactory as SalesListCollection;
use Hts\Marketplace\Model\ResourceModel\Orders\CollectionFactory as MpOrdersCollection;
use Magento\Sales\Model\Order\Payment\Transaction;

/**
 * Hts Marketplace Helper Payment.
 */
class Payment extends \Magento\Framework\App\Helper\AbstractHelper
{
        ...
        try {
            ...
            if ($mpAssignProductId) {
                $mpassignModel = $this->objectManager->create(
                    \Hts\MpAssignProduct\Model\Items::class
    ...
    public function getCreditPoints($sellerId)
    {
        $amount = 0;
        try {
            if ($this->_moduleManager->isEnabled('Hts_Mpsellercredits') && $sellerId !== '') {
