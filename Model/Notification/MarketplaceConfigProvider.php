...
namespace Hts\Marketplace\Model\Notification;
...
class MarketplaceConfigProvider
{
    ...
    protected $productModel;
     ...
     /**
      * @var \Hts\Marketplace\Model\SellerFactory
      */
    ...
    protected $productFactory;
     ...
     /**
      * @var \Hts\Marketplace\Model\FeedbackFactory
      */
    ...
    public function __construct(
        ...
        \Hts\Marketplace\Model\ProductFactory $productModel,
        \Hts\Marketplace\Model\SellerFactory $sellerModel,
        \Magento\Customer\Model\CustomerFactory $customerModel,
        \Magento\Catalog\Model\ProductFactory $productFactory,
        \Hts\Marketplace\Model\FeedbackFactory $feedbackFactory
    ) {
    ...
    public function getConfig()
    {
        if ($this->isAdminLoggedIn()) {
            $defaultImageUrl = $this->viewFileSystem->getUrlWithParams(
                'Hts_Marketplace::images/icons_notifications.png',
                []
            );
                ...
                if ($value->getAdminPendingNotification() == 1) {
                    ...
                    $desc = __(
                        sprintf(
                            ...
                            '<span class="ht-focus">'.$this->getProductName($value->getMageproductId()).'</span>',
                            '<span class="ht-focus">'.$this->getSellerName($value->getSellerId())->getName().'</span>'
                        )
                    );
                }
                ...
                if ($seller->getAdminNotification() == 1) {
                    ...
                    $desc = __(
                        sprintf(
                            ...
                            '<span class="ht-focus">'.$this->getSellerName($seller->getSellerId())->getName().'</span>'
                        )
                    );
                }
                $sellerData[] = [
