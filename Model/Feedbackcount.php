...
use Hts\Marketplace\Api\Data\FeedbackcountInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Feedbackcount Model.
 *
 * @method \Hts\Marketplace\Model\ResourceModel\Feedbackcount _getResource()
 * @method \Hts\Marketplace\Model\ResourceModel\Feedbackcount getResource()
 */
class Feedbackcount extends AbstractModel implements FeedbackcountInterface, IdentityInterface
{
    ...
    {
        $this->_init(\Hts\Marketplace\Model\ResourceModel\Feedbackcount::class);
    }
     ...
     *
     * @return \Hts\Marketplace\Model\Feedbackcount
     */
     ...
     * @param int $id
     *
     * @return \Hts\Marketplace\Api\Data\FeedbackcountInterface
     */
