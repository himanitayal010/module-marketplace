...
namespace Hts\Marketplace\Model\ResourceModel\Saleslist;

use \Hts\Marketplace\Model\ResourceModel\AbstractCollection;

/**
 * Hts Marketplace ResourceModel Saleslist collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Hts\Marketplace\Model\Saleslist::class,
            \Hts\Marketplace\Model\ResourceModel\Saleslist::class
        );
    ...
    /**
     * Join with Marketplace Product Table
     */
    public function joinMarketplaceProductTable()
    {
        $joinTable = $this->getTable('marketplace_product');
        $this->getSelect()->join($joinTable.' as mp', 'main_table.mageproduct_id = mp.mageproduct_id');
    }
}
