...
namespace Hts\Marketplace\Model\ResourceModel\OrderPendingMails;

use \Hts\Marketplace\Model\ResourceModel\AbstractCollection;

/**
 * Hts Marketplace ResourceModel OrderPendingMails collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Hts\Marketplace\Model\OrderPendingMails::class,
