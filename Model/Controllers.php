 ...
 *
 * @method \Hts\Marketplace\Model\ResourceModel\Controllers _getResource()
 * @method \Hts\Marketplace\Model\ResourceModel\Controllers getResource()
 */
class Controllers extends AbstractModel implements ControllersInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \Hts\Marketplace\Model\ResourceModel\Controllers::class
        );
    }
     ...
     *
     * @return \Hts\Marketplace\Model\Controllers
     */
