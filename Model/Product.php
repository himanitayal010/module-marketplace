...
use Hts\Marketplace\Api\Data\ProductInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Product Model.
 *
 * @method \Hts\Marketplace\Model\ResourceModel\Product _getResource()
 * @method \Hts\Marketplace\Model\ResourceModel\Product getResource()
 */
class Product extends AbstractModel implements ProductInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \Hts\Marketplace\Model\ResourceModel\Product::class
        );
    }
     ...
     * @param int $id
     *
     * @return \Hts\Marketplace\Api\Data\ProductInterface
     */
