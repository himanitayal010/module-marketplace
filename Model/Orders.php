...
use Hts\Marketplace\Model\Saleslist;

/**
 * Marketplace Orders Model.
 *
 * @method \Hts\Marketplace\Model\ResourceModel\Orders _getResource()
 * @method \Hts\Marketplace\Model\ResourceModel\Orders getResource()
 */
class Orders extends AbstractModel implements OrdersInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \Hts\Marketplace\Model\ResourceModel\Orders::class
        );
    }
     ...
     *
     * @return \Hts\Marketplace\Model\Orders
     */
