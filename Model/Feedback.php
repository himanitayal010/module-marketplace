...
use Hts\Marketplace\Api\Data\FeedbackInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Marketplace Feedback Model
 *
 * @method \Hts\Marketplace\Model\ResourceModel\Feedback _getResource()
 * @method \Hts\Marketplace\Model\ResourceModel\Feedback getResource()
 */
class Feedback extends AbstractModel implements FeedbackInterface, IdentityInterface
{
    ...
    {
        $this->_init(
            \Hts\Marketplace\Model\ResourceModel\Feedback::class
        );
    }
     ...
     *
     * @return \Hts\Marketplace\Model\Feedback
     */
     ...
     *
     * @param int $id
     * @return \Hts\Marketplace\Api\Data\FeedbackInterface
     */
