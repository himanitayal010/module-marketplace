        ...
        */
        ...
        foreach ($sellerProArr as $key => $value) {
            ...
            $this->notificationHelper->saveNotification(
                \Hts\Marketplace\Model\Notification::TYPE_ORDER,
                $sellerOrderId,
                $lastOrderId
            );
        }
    ...
    public function getSellerProductData($order, $ratesPerCurrency)
    {
        ...
        */
        ...
        foreach ($order->getAllItems() as $item) {
            ...
            $collectionsave->setCpprostatus(\Hts\Marketplace\Model\Saleslist::PAID_STATUS_PENDING);
