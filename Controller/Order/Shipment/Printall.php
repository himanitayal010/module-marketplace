...
/**
 * Hts Marketplace Order Shipment Printall pdf Controller by date range.
 */
class Printall extends \Hts\Marketplace\Controller\Order
{
            ...
            try {
                ...
                if (!empty($shipmentIds)) {
                    ...
                    $pdf = $this->_objectManager->create(
                        \Hts\Marketplace\Model\Order\Pdf\Shipment::class
                    )->getPdf($shipments);
