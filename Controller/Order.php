...
namespace Hts\Marketplace\Controller;
...
use Hts\Marketplace\Model\OrdersFactory as MpOrdersModel;
use Magento\Sales\Model\ResourceModel\Order\Invoice\Collection as InvoiceCollection;
use Hts\Marketplace\Model\SellerFactory as MpSellerModel;
...
abstract class Order extends Action
{
    ...
    /**
     * @var \Hts\Marketplace\Model\Order\Pdf\Creditmemo
     */
    protected $creditmemoPdf;

    /**
     * @var \Hts\Marketplace\Model\Order\Pdf\Invoice
     */
     ...
     * @param \Hts\Marketplace\Model\Order\Pdf\Creditmemo   $creditmemoPdf
     * @param \Hts\Marketplace\Model\Order\Pdf\Invoice      $invoicePdf
    ...
    public function __construct(
        ...
        \Hts\Marketplace\Model\Order\Pdf\Creditmemo $creditmemoPdf,
        \Hts\Marketplace\Model\Order\Pdf\Invoice $invoicePdf,
