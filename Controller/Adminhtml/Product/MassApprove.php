...
namespace Hts\Marketplace\Controller\Adminhtml\Product;
...
class MassApprove extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Hts\Marketplace\Model\ProductFactory
     */
    ...
    /**
     * @var \Hts\Marketplace\Helper\Email
     */
    protected $mpEmailHelper;

    /**
     * @var \Hts\Marketplace\Helper\Notification
     */
     ...
     * @param \Hts\Marketplace\Model\ProductFactory $mpProductFactory
     ...
     * @param \Hts\Marketplace\Helper\Email $mpEmailHelper
     * @param \Hts\Marketplace\Helper\Notification $mpNotificationHelper
     */
    public function __construct(
        ...
        \Hts\Marketplace\Model\ProductFactory $mpProductFactory,
        ...
        \Hts\Marketplace\Helper\Email $mpEmailHelper,
        \Hts\Marketplace\Helper\Notification $mpNotificationHelper
    ) {
    ...
    public function execute()
    {
        ...
        $details = ['status' => $status, 'seller_pending_notification' => 1, 'is_approved' => 1];
        ...
        foreach ($collection as $item) {
            ...
            $this->_eventManager->dispatch('mp_approve_product', ['product' => $pro, 'seller' => $seller]);
        }
    ...
    {
        return $this->_authorization->isAllowed('Hts_Marketplace::product');
    }
}
