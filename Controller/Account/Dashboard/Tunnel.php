...
namespace Hts\Marketplace\Controller\Account\Dashboard;

use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Framework\Controller\Result;
use Magento\Framework\Encryption\Helper\Security;
use Hts\Marketplace\Helper\Dashboard\Data as MpDashboardHelper;
use Hts\Marketplace\Helper\Data as MpHelper;

/**
 * Hts Marketplace Account Dashboard Tunnel Controller.
 */
class Tunnel extends Action
{
    ...
    public function execute()
    {
        ...
        if ($getEncodedParamData && $getEncryptedHashData) {
            /** @var $helper \Hts\Marketplace\Helper\Dashboard\Data */
                ...
                if ($params) {
                    try {
                        ...
                        $response = $httpZendClient->setUri(
                            \Hts\Marketplace\Block\Account\Dashboard\Diagrams::GOOGLE_API_URL
                        )->setParameterGet(
                            $params
                        )->setConfig(
                            ['timeout' => 5]
