...
use Hts\Marketplace\Helper\Email as MpEmailData;
use Magento\Framework\Json\Helper\Data as JsonHelper;
use \AllowDynamicProperties;
#[\AllowDynamicProperties]

/**
 * Hts Marketplace Reportflag controller.
 */
class Reportflag extends Action
{
    ...
    /**
     * @var \Hts\Marketplace\Model\ProductFlagsFactory
     */
    ...
    public function __construct(
        ...
        \Hts\Marketplace\Model\ProductFlagsFactory $productFlags
    ) {
        $this->helper = $helper;
