define('sellerNavigationScroll', [
    ...
    var win = $(window),
        subMenuClass = '.ht-mp-submenu',
        fixedClassName = 'fixed',
        menu = $('.ht-mp-menu-wrapper'),
        content = $('.ht-mp-page-wrapper'),
        menuItems = $('#ht-mp-nav').children('li'),
    ...
    menuItems.on('click', function (e) {
        ...
        var submenu = $(this).children(subMenuClass),
            delta,
            logo = $('.ht-mp-logo')[0].offsetHeight;
    ...
    $.widget('mage.sellerNavigation', {
        options: {
            selectors: {
                ...
                topLevelHref: '> a',
                subMenu: '> .ht-mp-submenu',
                closeSubmenuBtn: '[data-role="ht-mp-close-submenu"]'
            },
            overlayTmpl: '<div class="ht-mp-menu-overlay"></div>'
        },
