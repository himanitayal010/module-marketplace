                        ...
                        if (productId == 'on') {
                            $('#crosssell-product-block-wrapper .data-row').each(function () {
                                ...
                                tmpl = progressTmpl({
                                    data: {
                                        index: indexValue,
                                        id: trElement.find('.ht-mp-grid-id-cell').find('div').text(),
                                        name: trElement.find('.ht-mp-grid-name-cell').find('div').text(),
                                        status: trElement.find('.ht-mp-grid-status-cell').find('div').text(),
                                        attribute_set: trElement.find('.ht-mp-grid-attributeset-cell').find('div').text(),
                                        sku: trElement.find('.ht-mp-grid-sku-cell').find('div').text(),
                                        price: trElement.find('.ht-mp-grid-price-cell').find('div').text(),
                                        thumbnail: trElement.find('.data-grid-thumbnail-cell').find('img').attr('src'),
                                        position: indexValue+1,
                                        record_id: trElement.find('.ht-mp-grid-id-cell').find('div').text()
                                    }
                                });
                                indexValue++;
