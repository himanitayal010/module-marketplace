                    ...
                    for (i=0; i<len; i++) {
                        ...
                        if (checkn==1) {
                            if (newdata[i].counting === 0) {
                                thisthis.parent(".ht-cat-container").after('<div class="ht-removable ht-cat-container" style="display:none;margin-left:'+pxl+'px;"><span  class="ht-no"></span><span class="ht-foldersign"></span><span class="ht-elements ht-cat-name">'+ name +'</span><input class="ht-elements" type="checkbox" checked value='+ id+'></div>');
                            } else {
                                thisthis.parent(".ht-cat-container").after('<div class="ht-removable ht-cat-container" style="display:none;margin-left:'+pxl+'px;"><span  class="ht-plusend"></span><span class="ht-foldersign"></span><span class="ht-elements ht-cat-name">'+ name +'</span><input class="ht-elements" type="checkbox" checked value='+ id +'></div>');
                            }
                        } else {
                            if (newdata[i].counting === 0) {
                                thisthis.parent(".ht-cat-container").after('<div class="ht-removable ht-cat-container" style="display:none;margin-left:'+pxl+'px;"><span  class="ht-no"></span><span class="ht-foldersign"></span><span class="ht-elements ht-cat-name">'+ name +'</span><input class="ht-elements" type="checkbox" value='+ id+'></div>');
                            } else {
                                thisthis.parent(".ht-cat-container").after('<div class="ht-removable ht-cat-container" style="display:none;margin-left:'+pxl+'px;"><span  class="ht-plusend"></span><span class="ht-foldersign"></span><span class="ht-elements ht-cat-name">'+ name +'</span><input class="ht-elements" type="checkbox" value='+ id +'></div>');
                            }
                        }
                    }
